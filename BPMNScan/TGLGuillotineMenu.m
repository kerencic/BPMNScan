...
-(void)setupMenu{
   ...
   // menuView.backgroundColor = menuColor;
    ...
    float tableViewW = 300.0;
    
    menuTableView = [[UITableView alloc ]initWithFrame:CGRectMake((screenW - tableViewW)/2, tableViewMarginTop + navBarH, tableViewW, screenH - 100 - tableViewMarginTop)];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    UIView *mainView = [[UIView alloc] initWithFrame:cell.contentView.bounds];
    mainView.backgroundColor = [UIColor AP_basicOrangeColorWithTransparent:1.0];
    [cell addSubview:mainView];
    
    UILabel *titleLabel = [[UILabel alloc] initWithFrame:mainView.bounds];
    titleLabel.textColor = [UIColor whiteColor];
    titleLabel.textAlignment = NSTextAlignmentCenter;
    titleLabel.font = [UIFont systemFontOfSize:19.0];
    titleLabel.text = [self.menuTitles objectAtIndex:indexPath.row];
