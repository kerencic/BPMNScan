...
- (instancetype)initWithFrame:(CGRect)frame {
  ...
  self.layer.backgroundColor = [UIColor colorWithRed:255.0/255.0 green:105.0/255.0 blue:0.0/255.0 alpha:1.0].CGColor;
  self.layer.cornerRadius = CGRectGetHeight(self.bounds) / 2;
  self.layer.borderColor = [UIColor colorWithRed:255.0/255.0 green:105.0/255.0 blue:0.0/255.0 alpha:1.0].CGColor;
...
- (instancetype)initWithFrame:(CGRect)frame {
  ...
  self.innerCircle = [[AYTouchViewInnerCircle alloc] initWithFrame:CGRectMake(0, -200, self.bounds.size.width, self.bounds.size.height)];
  [self addSubview:self.innerCircle];
  self.firstOuterCircle = [[AYTouchViewOuterCircle alloc] initWithFrame:CGRectMake(0, -200, self.bounds.size.width, self.bounds.size.height)];
  [self addSubview:self.firstOuterCircle];
  self.secondOuterCircle = [[AYTouchViewOuterCircle alloc] initWithFrame:CGRectMake(0, -200, self.bounds.size.width, self.bounds.size.height)];
